...
(function (j) {
    ...
    q(C.prototype, {defaultColorAxisOptions: {lineWidth: 0, gridLineWidth: 1, tickPixelInterval: 72, startOnTick: !0, endOnTick: !0, offset: 0, marker: {animation: {duration: 50}, color: "gray", width: 0.01}, labels: {overflow: "justify"}, minColor: "#EFEFFF", maxColor: "#003875", tickLength: 5}, init: function (a, b) {
        ...
        c.length || i(this.dataClasses, function (d, l) {
            ...
            y !== void 0 && k !== void 0 && (g += " - ");
            k !== void 0 && (g += I(k, e) + f);
            c.push(q({chart: b, name: g, options: {}, drawLegendSymbol: E.drawRectangle, visible: !0, setState: s, setVisible: function () {
                j = this.visible = !j;
    ...
    D = {pointAttrToOptions: {stroke: "borderColor", "stroke-width": "borderWidth", fill: "color", dashstyle: "dashStyle"}, pointArrayMap: ["value"], axisTypes: ["xAxis", "yAxis", "colorAxis"], optionalAxis: "colorAxis", trackerGroups: ["group", "markerGroup", "dataLabelsGroup"], getSymbol: s, parallelArrays: ["x", "y", "value"], colorKey: "value", translateColors: function () {
    ...
    q(z.prototype, {renderMapNavigation: function () {
        ...
        if (n(b.enableButtons, b.enabled) && !a.renderer.forExport)for (d in c)if (c.hasOwnProperty(d))f = m(b.buttonOptions, c[d]), e = f.theme, g = e.states, e = a.renderer.button(f.text,
            0, 0, h, e, g && g.hover, g && g.select, 0, d === "zoomIn" ? "topbutton" : "bottombutton").attr({width: f.width, height: f.height, title: a.options.lang[d], zIndex: 5}).css(f.style).add(), e.handler = f.onclick, e.align(q(f, {width: e.width, height: 2 * e.height}), null, f.alignTo)
        ...
        i *= a;
        h = this.fitToBox({x: h - l * (d ? (d - f.pos) / f.len : 0.5), y: y - i * (e ? (e - g.pos) / g.len : 0.5), width: l, height: i}, {x: f.dataMin, y: g.dataMin, width: f.dataMax - f.dataMin, height: g.dataMax - g.dataMin});
    ...
    q(v.prototype, {onContainerDblClick: function (a) {
    ...
    r.map = m(r.scatter, {allAreas: !0, animation: !1, nullColor: "#F8F8F8", borderColor: "silver", borderWidth: 1, marker: null, stickyTracking: !1,
    ...
    v = u(A, {applyOptions: function (a, b) {
    ...
    k.map = u(k.scatter, m(D, {type: "map",
        pointClass: v, supportsDrilldown: !0, getExtremesFromAll: !0, useMapGeometry: !0, forceDL: !0, getBox: function (a) {
        ...
        }, drawGraph: s, drawDataLabels: s, doFullTranslate: function () {
            ...
            }), this.baseTrans = {originX: a.min - a.minPixelPadding / a.transA, originY: b.min - b.minPixelPadding / b.transA + (b.reversed ? 0 : b.len / b.transA),
                transAX: a.transA, transAY: b.transA}) : (c = a.transA / f.transAX, d = b.transA / f.transAY, c > 0.99 && c < 1.01 && d > 0.99 && d < 1.01 ? (b = a = 0, d = c = 1) : (a = a.toPixels(f.originX, !0), b = b.toPixels(f.originY, !0)), this.transformGroup.animate({translateX: a, translateY: b, scaleX: c, scaleY: d}));
            ...
            if (!a)a = Math.min(d.width / b.width, d.height / b.height), c.shapeArgs = {scaleX: a, scaleY: a, translateX: d.x, translateY: d.y}, i(this.points, function (a) {
    ...
    k.mapline = u(k.map, {type: "mapline", pointAttrToOptions: {stroke: "color", "stroke-width": "lineWidth", fill: "fillColor", dashstyle: "dashStyle"}, drawLegendSymbol: k.line.prototype.drawLegendSymbol});
    r.mappoint = m(r.scatter, {dataLabels: {enabled: !0, formatter: function () {
    ...
    if (k.bubble)r.mapbubble =
        m(r.bubble, {animationLimit: 500, tooltip: {pointFormat: "{point.name}: {point.z}"}}), k.mapbubble = u(k.bubble, {pointClass: u(A, {applyOptions: v.prototype.applyOptions}), xyFromShape: !0, type: "mapbubble", pointArrayMap: ["z"], getMapData: k.map.prototype.getMapData, getBox: k.map.prototype.getBox, setData: k.map.prototype.setData});
    x.plotOptions.heatmap = m(x.plotOptions.scatter, {animation: !1, borderWidth: 0, nullColor: "#F8F8F8", dataLabels: {formatter: function () {
        return this.point.value
    }, verticalAlign: "middle", crop: !1, overflow: !1,
        style: {color: "white", fontWeight: "bold", HcTextStroke: "1px rgba(0,0,0,0.5)"}}, marker: null, tooltip: {pointFormat: "{point.x}, {point.y}: {point.value}<br/>"}, states: {normal: {animation: !0}, hover: {brightness: 0.2}}});
    k.heatmap = u(k.scatter, m(D, {type: "heatmap", pointArrayMap: ["y", "value"], hasPointSpecificOptions: !0, supportsDrilldown: !0, getExtremesFromAll: !0, init: function () {
        ...
        }, drawPoints: k.column.prototype.drawPoints, animate: s, getBox: s, drawLegendSymbol: E.drawRectangle, getExtremes: function () {
            w.prototype.getExtremes.call(this, this.valueData);
            this.valueMin = this.dataMin;
            this.valueMax = this.dataMax;
    ...
    j.geojson = function (a, b, c) {
        ...
        i(a.features, function (a) {
            ...
            b === "map" || b === "mapbubble" ? (j === "Polygon" ? (i(c, f), e.push("Z")) : j === "MultiPolygon" && (i(c, function (a) {
                i(a, f)
            }), e.push("Z")), e.length && (k = {path: e})) : b === "mapline" ? (j === "LineString" ? f(c) : j === "MultiLineString" && i(c, f), e.length && (k = {path: e})) : b === "mappoint" && j === "Point" && (k = {x: c[0], y: -c[1]});
    ...
    x.mapNavigation = {buttonOptions: {alignTo: "plotBox", align: "left", verticalAlign: "top", x: 0, width: 18, height: 18, style: {fontSize: "15px", fontWeight: "bold", textAlign: "center"}, theme: {"stroke-width": 1}}, buttons: {zoomIn: {onclick: function () {
        this.mapZoom(0.5)
    }, text: "+",
        y: 0}, zoomOut: {onclick: function () {
        this.mapZoom(2)
    }, text: "-", y: 28}}};
    ...
    j.Map = function (a, b) {
        var c = {endOnTick: !1, gridLineWidth: 0, lineWidth: 0, minPadding: 0, maxPadding: 0, startOnTick: !1, title: null, tickPositions: []}, d;
        d = a.series;
        a.series = null;
        a = m({chart: {panning: "xy", type: "map"}, xAxis: c, yAxis: m(c, {reversed: !0})}, a, {chart: {inverted: !1, alignTicks: !1, preserveAspectRatio: !0}});
        a.series = d;
        return new z(a, b)
    }
})(Highcharts);
