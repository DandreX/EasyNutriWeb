...
(function () {
    ...
    $a = function (a, b, c) {
        ...
        var a = p(a, "%Y-%m-%d %H:%M:%S"), d = new Ka(b - rb), e, f = d[tb](), g = d[ub](), h = d[vb](), i = d[wb](), j = d[xb](), k = J.lang, l = k.weekdays, d = q({a: l[g].substr(0, 3), A: l[g], d: Ea(h), e: h, b: k.shortMonths[i], B: k.months[i], m: Ea(i + 1), y: j.toString().substr(2, 2), Y: j, H: Ea(f), I: Ea(f % 12 || 12), l: f % 12 || 12, M: Ea(d[sb]()), p: f < 12 ? "AM" : "PM", P: f < 12 ? "am" : "pm", S: Ea(d.getSeconds()), L: Ea(w(b % 1E3), 3)}, K.dateFormats);
    ...
    Oa = {millisecond: 1, second: 1E3, minute: 6E4, hour: 36E5, day: 864E5, week: 6048E5, month: 26784E5, year: 31556952E3};
    ...
    var db = P.adapterRun, Kb = P.getScript, Ta = P.inArray, o = P.each, Cb = P.grep, Lb =
        P.offset, Ua = P.map, N = P.addEvent, Y = P.removeEvent, C = P.fireEvent, Mb = P.washMouseEvent, eb = P.animate, Va = P.stop, P = {enabled: !0, x: 0, y: 15, style: {color: "#606060", cursor: "default", fontSize: "11px"}};
    J = {colors: "#7cb5ec,#434348,#90ed7d,#f7a35c,#8085e9,#f15c80,#e4d354,#8085e8,#8d4653,#91e8e1".split(","), symbols: ["circle", "diamond", "square", "triangle", "triangle-down"], lang: {loading: "Loading...", months: "January,February,March,April,May,June,July,August,September,October,November,December".split(","), shortMonths: "Jan,Feb,Mar,Apr,May,Jun,Jul,Aug,Sep,Oct,Nov,Dec".split(","),
        weekdays: "Sunday,Monday,Tuesday,Wednesday,Thursday,Friday,Saturday".split(","), decimalPoint: ".", numericSymbols: "k,M,G,T,P,E".split(","), resetZoom: "Reset zoom", resetZoomTitle: "Reset zoom level 1:1", thousandsSep: ","}, global: {useUTC: !0, canvasToolsURL: "http://code.highcharts.com/maps/1.0.4/modules/canvas-tools.js", VMLRadialGradientURL: "http://code.highcharts.com/maps/1.0.4/gfx/vml-radial-gradient.png"}, chart: {borderColor: "#4572A7", borderRadius: 0, defaultSeriesType: "line", ignoreHiddenSeries: !0, spacing: [10,
        10, 15, 10], backgroundColor: "#FFFFFF", plotBorderColor: "#C0C0C0", resetZoomButton: {theme: {zIndex: 20}, position: {align: "right", x: -10, y: 10}}}, title: {text: "Chart title", align: "center", margin: 15, style: {color: "#333333", fontSize: "18px"}}, subtitle: {text: "", align: "center", style: {color: "#555555"}}, plotOptions: {line: {allowPointSelect: !1, showCheckbox: !1, animation: {duration: 1E3}, events: {}, lineWidth: 2, marker: {lineWidth: 0, radius: 4, lineColor: "#FFFFFF", states: {hover: {enabled: !0, lineWidthPlus: 1, radiusPlus: 2}, select: {fillColor: "#FFFFFF",
        lineColor: "#000000", lineWidth: 2}}}, point: {events: {}}, dataLabels: v(P, {align: "center", enabled: !1, formatter: function () {
        return this.y === null ? "" : oa(this.y, -1)
    }, verticalAlign: "bottom", y: 0}), cropThreshold: 300, pointRange: 0, states: {hover: {lineWidthPlus: 1, marker: {}, halo: {size: 10, opacity: 0.25}}, select: {marker: {}}}, stickyTracking: !0, turboThreshold: 1E3}}, labels: {style: {position: "absolute", color: "#3E576F"}}, legend: {enabled: !0, align: "center", layout: "horizontal", labelFormatter: function () {
        return this.name
    }, borderColor: "#909090",
    ...
    H.prototype = {opacity: 1, textProps: "fontSize,fontWeight,fontFamily,color,lineHeight,width,textDecoration,textShadow,HcTextStroke".split(","), init: function (a, b) {
        ...
        if (f) {
            ...
            f === "radialGradient" && n && !t(g.gradientUnits) && (g = v(g, {cx: n[0] - n[2] / 2 + g.cx * n[2], cy: n[1] - n[2] / 2 + g.cy * n[2], r: g.r * n[2], gradientUnits: "userSpaceOnUse"}));
            for (m in g)m !== "id" &&
            x.push(m, g[m]);
        ...
        updateShadows: function (a, b) {
            ...
            if (a) {
                ...
                for (e = 1; e <= i; e++) {
                    f = g.cloneNode(0);
                    h = i * 2 + 1 - 2 * e;
                    G(f, {isShadow: "true", stroke: a.color || "black", "stroke-opacity": j * e, "stroke-width": h, transform: "translate" + k, fill: S});
    ...
    ba.prototype = {Element: H, init: function (a, b, c, d, e) {
        ...
        return this.style = q({fontFamily: '"Lucida Grande", "Lucida Sans Unicode", Arial, Helvetica, sans-serif',
            fontSize: "12px"}, a)
    }, isHidden: function () {
                ...
                if (e !== "" || g.length === 1) {
                    ...
                    if (e !== " ") {
                        ...
                        if (l)for (var e = e.replace(/([^\^])-/g, "$1- ").split(" "), m = g.length > 1 || e.length > 1 && k.whiteSpace !== "nowrap", o, z, r = k.HcHeight, q = [], t = M(x), Db = 1; m && (e.length || q.length);)delete a.bBox, o = a.getBBox(), z = o.width, !ca && c.forExport && (z = c.measureSpanWidth(x.firstChild.data,
                            a.styles)), o = z > l, !o || e.length === 1 ? (e = q, q = [], e.length && (Db++, r && Db * t > r ? (e = ["..."], a.attr("title", a.textStr)) : (x = y.createElementNS(xa, "tspan"), G(x, {dy: t, x: j}), p && G(x, "style", p), b.appendChild(x))), z > l && (l = z)) : (x.removeChild(x.firstChild), q.unshift(e.pop())), e.length && x.appendChild(y.createTextNode(e.join(" ").replace(/- /g, "-")));
                        n++
                    }
                }
            })
        ...
        var j = this.label(a, b, c, i, null, null, null, null, "button"), k = 0, l, n, m, x, p, o, a = {x1: 0, y1: 0, x2: 0, y2: 1}, e = v({"stroke-width": 1, stroke: "#CCCCCC",
        ...
        m = e.style;
        delete e.style;
        f = v(e, {stroke: "#68A", fill: {linearGradient: a, stops: [
            [0, "#FFF"],
            [1, "#ACF"]
        ]}}, f);
        x = f.style;
        delete f.style;
        g = v(e, {stroke: "#68A", fill: {linearGradient: a, stops: [
            [0, "#9BD"],
            [1, "#CDF"]
        ]}}, g);
        p = g.style;
        ...
        var e = fa(a) ? a.r : e, g = this.createElement("rect"), a = fa(a) ? a : a === r ? {} : {x: a, y: b, width: s(c, 0), height: s(d, 0)};
        ...
        if (h)g = this.path(h), q(g, {symbolName: a, x: b, y: c, width: d, height: e}), f && q(g, f); else if (i.test(a))k = function (a, b) {
            ...
            [f.width, f.height], g = this.image(j).attr({x: b, y: c}), g.isImg = !0, a ? k(g, a) : (g.attr({width: 0, height: 0}), $("img", {onload: function () {
        ...
        return q(m, {css: function (a) {
            ...
            return{width: z.width + 2 * E, height: z.height + 2 * E, x: z.x - E, y: z.y -
                E}
        }, shadow: function (a) {
            p && p.shadow(a);
            return m
    ...
    Na = ba;
    q(H.prototype, {htmlCss: function (a) {
        var b = this.element;
    ...
    q(ba.prototype, {html: function (a, b, c) {
            ...
            if (this.parentGroup = a) {
                if (b = a.div, !b) {
                    ...
                    o(j.reverse(), function (a) {
                        var d;
                        b = a.div = a.div || $(Ga, {className: G(a.element, "class")}, {position: "absolute", left: (a.translateX || 0) + "px", top: (a.translateY ||
                            0) + "px"}, b || c);
                        d = b.style;
    ...
    if (!ca && !ga)L = {init: function (a, b) {
        ...
        L.prototype.xSetter, L = {Element: L, isIE8: wa.indexOf("MSIE 8.0") > -1, init: function (a, b, c, d) {
        var e;
        this.alignedObjects = [];
        ...
        return q(e, {members: [], left: (f ? a.x : a) + 1, top: (f ? a.y : b) + 1, width: (f ? a.width : c) - 1, height: (f ? a.height : d) - 1, getCSS: function (a) {
            var b = a.element, c = b.nodeName, a = a.inverted, d = this.top - (c === "shape" ? b.offsetTop : 0), e = this.left, b = e + this.width, f = d + this.height, d = {clip: "rect(" + w(a ? e : d) + "px," + w(a ?
        ...
        D(a, {flip: "x", left: B(d.width) - (e ? B(e.top) :
    ...
    La.prototype = {addLabel: function () {
        ...
        this.isFirst = k;
        this.isLast = l;
        b = a.labelFormatter.call({axis: a, chart: c, isFirst: k, isLast: l, dateTimeLabelFormat: n, value: a.isLog ? ua(la(f)) : f});
        ...
        if (n && O)q === "inside" && (O = -O), d.opposite && (O = -O), h = this.getMarkPath(v, u, O, n * A, g, f), m ? m.animate({d: h, opacity: c}) : this.mark = f.path(h).attr({stroke: E, "stroke-width": n, opacity: c}).add(d.axisGroup);
    ...
    Q.prototype = {defaultOptions: {dateTimeLabelFormats: {millisecond: "%H:%M:%S.%L", second: "%H:%M:%S", minute: "%H:%M",
        ...
        defaultYAxisOptions: {endOnTick: !0, gridLineWidth: 1, tickPixelInterval: 72, showLastLabel: !0, labels: {x: -8, y: 3}, lineWidth: 0, maxPadding: 0.05, minPadding: 0.05, startOnTick: !0, tickWidth: 0, title: {rotation: 270, text: "Values"}, stackLabels: {enabled: !1, formatter: function () {
        ...
        }, style: P.style}}, defaultLeftAxisOptions: {labels: {x: -15, y: null}, title: {rotation: 270}}, defaultRightAxisOptions: {labels: {x: 15, y: null}, title: {rotation: 90}}, defaultBottomAxisOptions: {labels: {x: 0, y: null}, title: {rotation: 0}}, defaultTopAxisOptions: {labels: {x: 0,
            ...
            var a = this.isLog;
            return{min: a ? ua(la(this.min)) : this.min, max: a ?
                ua(la(this.max)) : this.max, dataMin: this.dataMin, dataMax: this.dataMax, userMin: this.userMin, userMax: this.userMax}
            ...
            if (x && x.text && x.enabled !== !1) {
                if (!a.axisTitle)a.axisTitle = c.text(x.text, 0, 0, x.useHTML).attr({zIndex: 7, rotation: x.rotation || 0, align: x.textAlign || {low: "left", middle: "center", high: "right"}[x.align]}).addClass("highcharts-" + this.coll.toLowerCase() + "-title").css(x.style).add(a.axisGroup), a.axisTitle.isNew = !0;
            ...
            if (O)b = a.getLinePath(O), a.axisLine ?
                a.axisLine.animate({d: b}) : a.axisLine = e.path(b).attr({stroke: f.lineColor, "stroke-width": O, zIndex: 7}).add(a.axisGroup), a.axisLine[s ? "show" : "hide"]();
    ...
    Fb.prototype = {init: function (a, b) {
        ...
        q(f, {x: g ? (2 * f.x + a) /
            3 : a, y: g ? (f.y + b) / 2 : b, anchorX: h ? r : g ? (2 * f.anchorX + c) / 3 : c, anchorY: h ? r : g ? (f.anchorY + d) / 2 : d});
        e.label.attr(f);
        ...
        i === !1 ? this.hide() : (this.isHidden && (Va(d), d.attr("opacity", 1).show()), d.attr({text: i}), k = e.borderColor ||
            a.color || h.color || "#606060", d.attr({stroke: k}), this.updatePosition({plotX: f, plotY: g, negative: a.negative, ttBelow: a.ttBelow}), this.isHidden = !1);
    ...
    ya.prototype = {init: function (a, b) {
        ...
        if (this.hasDragged > 10) {
            ...
            if (b.hasCartesianSeries && (this.zoomX || this.zoomY) && l && !p && !this.selectionMarker)this.selectionMarker = b.renderer.rect(h, i, f ? 1 : j, g ? 1 : k, 0).attr({fill: c.selectionMarkerFill || "rgba(69,114,167,0.25)", zIndex: 7}).add();
            this.selectionMarker && f && (d -= n, this.selectionMarker.attr({width: U(d), x: (d > 0 ? 0 : d) + n}));
            this.selectionMarker && g && (d = e - m, this.selectionMarker.attr({height: U(d), y: (d >
                0 ? 0 : d) + m}));
    ...
    if (I.PointerEvent || I.MSPointerEvent) {
        var sa = {}, nb = !!I.PointerEvent, Qb = function () {
            ...
            a = a.originalEvent || a;
            if ((a.pointerType === "touch" || a.pointerType === a.MSPOINTER_TYPE_TOUCH) && V[ma])d(a), d = V[ma].pointer, d[b]({type: c, target: a.currentTarget, preventDefault: aa,
                touches: Qb()})
        };
        q(ya.prototype, {onContainerPointerDown: function (a) {
    ...
    Xa.prototype = {init: function (a, b) {
        ...
        if (b)c =
            ...
            var f = e.checkbox, g;
            f && (g = c + f.y + (a || 0) + 3, D(f, {left: b.translateX + e.checkboxOffset + f.x - 20 + "px", top: g + "px", display: g > c - 6 && g < c + d - 6 ? "" : S}))
        })
        ...
        if (!z) {
            ...
            a.legendItem = z = c.text(d.labelFormat ? Ia(d.labelFormat, a) : d.labelFormatter.call(a), l ? f + g : -g, this.baseline || 0, r).css(v(a.visible ? h : i)).attr({align: l ? "left" : "right", zIndex: 2}).add(a.legendGroup);
        ...
        e > d && (e = d);
        if (e > 0)b !== r && (ha = p(b, this.chart.animation)), this.nav.attr({translateX: j, translateY: f + this.padding + 7 + this.titleHeight, visibility: "visible"}), this.up.attr({fill: e === 1 ? g : h}).css({cursor: e === 1 ? "default" : "pointer"}), i.attr({text: e + "/" + d}), this.down.attr({x: 18 + this.pager.getBBox().width, fill: e === d ? g : h}).css({cursor: e === d ? "default" : "pointer"}), c = -c[e - 1] + this.initialItemY, this.scrollGroup.animate({translateY: c}), this.currentPage = e,
            this.positionCheckboxes(c)
    }};
    var Ya = K.LegendSymbolMixin = {drawRectangle: function (a, b) {
    ...
    pa.prototype = {init: function (a, b) {
        ...
        d && (d.css({width: (e.width || h) + "px"}).align(q({y: b +
            (f.margin - 13) + g.fontMetrics(f.style.fontSize, d).b}, e), !1, "spacingBox"), !e.floating && !e.verticalAlign && (b = Ha(b + d.getBBox().height)));
        ...
        getContainer: function () {
            ...
            c = this.chartWidth;
            d = this.chartHeight;
            this.container = a = $(Ga, {className: "highcharts-container" + (b.className ? " " + b.className : ""), id: e},
                q({position: "relative", overflow: "hidden", width: c + "px", height: d + "px", textAlign: "left", lineHeight: "normal", zIndex: 0, "-webkit-tap-highlight-color": "rgba(0,0,0,0)"}, b.style), this.renderToClone || a);
            ...
            b = Ha(s(d, h[3]) / 2);
            c = Ha(s(d, h[0]) / 2);
            this.clipBox = {x: b, y: c, width: ea(this.plotSizeX - s(d, h[1]) / 2 - b), height: s(0, ea(this.plotSizeY - s(d, h[2]) / 2 - c))};
            ...
            if (n)g ? g.animate(g.crisp({x: p, y: o, width: q, height: r, strokeWidth: -n})) : this.plotBorder = b.rect(p, o, q, r, 0, -n).attr({stroke: a.plotBorderColor, "stroke-width": n, fill: S,
                zIndex: 1}).add();
            this.isDirtyBox = !1
    ...
    ia.prototype = {init: function (a, b, c) {
        this.series = a;
    ...
    T.prototype = {isCartesian: !0, type: "line", pointClass: ia, sorted: !0, requireSorting: !0, pointAttrToOptions: {stroke: "lineColor", "stroke-width": "lineWidth", fill: "fillColor", r: "radius"}, axisTypes: ["xAxis", "yAxis"], colorCounter: 0, parallelArrays: ["x", "y"], init: function (a, b) {
    ...
    }, drawLegendSymbol: Ya.drawLineMarker, setData: function (a, b, c, d) {
        ...
        processData: function (a) {
            ...
            if (l.enabled !== !1 || this._hasPointMarkers)for (f =
                                                                   b.length; f--;)if (g = b[f], d = ea(g.plotX), e = g.plotY, k = g.graphic, m = g.marker || {}, o = !!g.marker, a = t && m.enabled === r || m.enabled, s = c.isInsidePlot(w(d), e, c.inverted), a && e !== r && !isNaN(e) && g.y !== null)if (a = g.pointAttr[g.selected ? "select" : ""] || n, h = a.r, i = p(m.symbol, this.symbol), j = i.indexOf("url") === 0, k)k[s ? "show" : "hide"](!0).animate(q({x: d - h, y: e - h}, k.symbolName ? {width: 2 * h, height: 2 * h} : {})); else {
            ...
            ], d = b.lineWidth, e = b.dashStyle, f = b.linecap !==
                "square", g = this.getGraphPath(), h = b.negativeColor;
            h && c.push(["graphNeg", h]);
            o(c, function (c, h) {
                var k = c[0], l = a[k];
                if (l)Va(l), l.animate({d: g}); else if (d && g.length)l = {stroke: c[1], "stroke-width": d, fill: S, zIndex: 1}, e ? l.dashstyle = e : f && (l["stroke-linecap"] = l["stroke-linejoin"] = "round"), a[k] = a.chart.renderer.path(g).attr(l).add(a.group).shadow(!h && b.shadow)
            })
        }, clipNeg: function () {
    ...
    q(pa.prototype, {addSeries: function (a, b, c) {
        var d, e = this;
        ...
        var b = this, c = b.options, d = b.loadingDiv, e = c.loading, f = function () {
            d && D(d, {left: b.plotLeft + "px", top: b.plotTop + "px", width: b.plotWidth + "px", height: b.plotHeight + "px"})
        };
        if (!d)b.loadingDiv = d = $(Ga, {className: "highcharts-loading"}, q(e.style, {zIndex: 10, display: S}), b.container), b.loadingSpan = $("span", null, e.labelStyle, d), N(b, "redraw", f);
        b.loadingSpan.innerHTML =
            a || c.lang.loading;
        if (!b.loadingShown)D(d, {opacity: 0, display: ""}), eb(d, {opacity: e.style.opacity}, {duration: e.showDuration || 0}), b.loadingShown = !0;
        f()
    ...
    q(ia.prototype, {update: function (a, b, c, d) {
        function e() {
            f.applyOptions(a);
    ...
    q(T.prototype, {addPoint: function (a, b, c, d) {
    ...
    q(Q.prototype, {update: function (a, b) {
    ...
    P = da(T);
    u.line = P;
    W.column = v(ra, {borderColor: "#FFFFFF", borderRadius: 0, groupPadding: 0.2, marker: null, pointPadding: 0.1, minPointLength: 0, cropThreshold: 50, pointRange: null, states: {hover: {brightness: 0.1, shadow: !1, halo: !1}, select: {color: "#C0C0C0",
        borderColor: "#000000", shadow: !1}}, dataLabels: {align: null, verticalAlign: null, y: null}, stickyTracking: !1, tooltip: {distance: 6}, threshold: 0});
    P = da(T, {type: "column", pointAttrToOptions: {stroke: "borderColor", fill: "color", r: "borderRadius"}, cropShoulder: 0, trackerGroups: ["group", "dataLabelsGroup"], negStacks: !0, init: function () {
        ...
        return a.columnMetrics = {width: l, offset: b +
    ...
    }, getSymbol: aa, drawLegendSymbol: Ya.drawRectangle, drawGraph: aa, drawPoints: function () {
    ...
    u.column = P;
    W.scatter = v(ra, {lineWidth: 0, tooltip: {headerFormat: '<span style="color:{series.color}">●</span> <span style="font-size: 10px;"> {series.name}</span><br/>',
        pointFormat: "x: <b>{point.x}</b><br/>y: <b>{point.y}</b><br/>"}, stickyTracking: !1});
    ra = da(T, {type: "scatter", sorted: !1, requireSorting: !1, noSharedTooltip: !0, trackerGroups: ["markerGroup", "dataLabelsGroup"], takeOrdinalPosition: !1, singularTooltips: !0, drawGraph: function () {
    ...
    if (u.pie)u.pie.prototype.drawDataLabels = function () {
        var a = this, b = a.data, c, d = a.chart, e = a.options.dataLabels, f = p(e.connectorPadding, 10), g = p(e.connectorWidth, 1), h = d.plotWidth, i = d.plotHeight, j, k, l = p(e.softConnector, !0), n = e.distance, m = a.center, q = m[2] / 2, r = m[1], t = n > 0, u, v, y, B = [
            [],
            []
        ], D, C, K, J, A, F = [0, 0, 0, 0], N = function (a, b) {
            return b.y - a.y
        };
        if (a.visible && (e.enabled || a._hasPointLabels)) {
            ...
            if (Fa(F) === 0 || this.verifyDataLabelOverflow(F))this.placeDataLabels(), t && g && o(this.points, function (b) {
                ...
                if ((u = b.dataLabel) && u._pos)K = u._attr.visibility, D = u.connX, C = u.connY, k = l ? ["M", D + (y[6] === "left" ? 5 : -5), C, "C", D, C, 2 * y[2] - y[4], 2 * y[3] - y[5], y[2], y[3], "L", y[4], y[5]] : ["M", D + (y[6] === "left" ? 5 : -5), C, "L", y[2],
                    y[3], "L", y[4], y[5]], j ? (j.animate({d: k}), j.attr("visibility", K)) : b.connector = j = a.chart.renderer.path(k).attr({"stroke-width": g, stroke: e.connectorColor || b.color || "#606060", visibility: K}).add(a.dataLabelsGroup); else if (j)b.connector = j.destroy()
            })
        }
    ...
    if (u.column)u.column.prototype.alignDataLabel = function (a, b, c, d, e) {
        ...
        if (h && (d = v(h), g && (d = {x: f.plotWidth - d.y - d.height, y: f.plotHeight - d.x - d.width, width: d.height, height: d.width}), !j))g ? (d.x += i ? 0 : d.width, d.width = 0) : (d.y += i ? d.height : 0, d.height = 0);
    ...
    q(Za.prototype, {defaultColorAxisOptions: {lineWidth: 0, gridLineWidth: 1, tickPixelInterval: 72, startOnTick: !0, endOnTick: !0, offset: 0, marker: {animation: {duration: 50}, color: "gray", width: 0.01}, labels: {overflow: "justify"}, minColor: "#EFEFFF", maxColor: "#003875", tickLength: 5}, init: function (a, b) {
        var c = a.options.legend.layout !== "vertical", d;
        d = v(this.defaultColorAxisOptions, {side: c ? 2 : 1, reversed: !c}, b, {isX: c, opposite: !c, showEmpty: !1, title: null, isColor: !0});
        ...
        getPlotLinePath: function (a, b, c, d, e) {
            ...
            c.length || o(this.dataClasses, function (d, i) {
                ...
                k !== r && l !== r && (g += " - ");
                l !== r && (g += oa(l, e) + f);
                c.push(q({chart: b, name: g, options: {}, drawLegendSymbol: Ya.drawRectangle, visible: !0, setState: aa, setVisible: function () {
                    j = this.visible = !j;
    ...
    L = {pointAttrToOptions: {stroke: "borderColor", "stroke-width": "borderWidth",
        fill: "color", dashstyle: "dashStyle"}, pointArrayMap: ["value"], axisTypes: ["xAxis", "yAxis", "colorAxis"], optionalAxis: "colorAxis", trackerGroups: ["group", "markerGroup", "dataLabelsGroup"], getSymbol: aa, parallelArrays: ["x", "y", "value"], colorKey: "value", translateColors: function () {
    ...
    W.map = v(W.scatter, {allAreas: !0, animation: !1, nullColor: "#F8F8F8", borderColor: "silver", borderWidth: 1, marker: null, stickyTracking: !1, dataLabels: {formatter: function () {
        return this.point.value
    }, verticalAlign: "middle", crop: !1, overflow: !1, padding: 0, style: {color: "white", fontWeight: "bold", HcTextStroke: "3px rgba(0,0,0,0.5)"}}, turboThreshold: 0, tooltip: {followPointer: !0, pointFormat: "{point.name}: {point.value}<br/>"}, states: {normal: {animation: !0}, hover: {brightness: 0.2, halo: null}}});
    var Gb = da(ia, {applyOptions: function (a, b) {
    ...
    u.map = da(u.scatter, v(L, {type: "map", pointClass: Gb, supportsDrilldown: !0, getExtremesFromAll: !0, useMapGeometry: !0, forceDL: !0, getBox: function (a) {
        ...
        T.prototype.setData.call(this,
            a, b)
    }, drawGraph: aa, drawDataLabels: aa, doFullTranslate: function () {
        ...
        o(a.data, function (e) {
            ...
            if (d)e.shapeType = "path", e.shapeArgs = {d: a.translatePath(e.path), "vector-effect": "non-scaling-stroke"}
        });
        a.translateColors()
    }, drawPoints: function () {
        ...
        if (this.chart.renderer.isSVG)b === !0 && (b = {duration: 1E3}),
            a ? c.attr({translateX: f + d.len / 2, translateY: g + e.len / 2, scaleX: 0.001, scaleY: 0.001}) : (c.animate({translateX: f, translateY: g, scaleX: 1, scaleY: 1}, b), this.animate = null)
        ...
        if (!a)a = Math.min(d.width / b.width, d.height / b.height), c.shapeArgs = {scaleX: a, scaleY: a, translateX: d.x, translateY: d.y}, o(this.points, function (a) {
            a.graphic.attr(c.shapeArgs).animate({scaleX: 1,
                scaleY: 1, translateX: 0, translateY: 0}, e)
        }), this.animate = null
    }, drawLegendSymbol: Ya.drawRectangle, animateDrillupFrom: function (a) {
    ...
    q(pa.prototype, {renderMapNavigation: function () {
        ...
        if (p(b.enableButtons, b.enabled) && !a.renderer.forExport)for (d in c)if (c.hasOwnProperty(d))f = v(b.buttonOptions,
            c[d]), e = f.theme, g = e.states, e = a.renderer.button(f.text, 0, 0, h, e, g && g.hover, g && g.select, 0, d === "zoomIn" ? "topbutton" : "bottombutton").attr({width: f.width, height: f.height, title: a.options.lang[d], zIndex: 5}).css(f.style).add(), e.handler = f.onclick, e.align(q(f, {width: e.width, height: 2 * e.height}), null, f.alignTo)
        ...
        j *= a;
        h = this.fitToBox({x: h - i * (d ? (d - f.pos) / f.len : 0.5), y: k - j * (e ? (e - g.pos) / g.len : 0.5), width: i, height: j}, {x: f.dataMin, y: g.dataMin, width: f.dataMax - f.dataMin, height: g.dataMax - g.dataMin});
    ...
    q(ya.prototype, {onContainerDblClick: function (a) {
        var b =
    ...
    u.mapline = da(u.map, {type: "mapline", pointAttrToOptions: {stroke: "color", "stroke-width": "lineWidth", fill: "fillColor", dashstyle: "dashStyle"}, drawLegendSymbol: u.line.prototype.drawLegendSymbol});
    W.mappoint = v(W.scatter, {dataLabels: {enabled: !0, formatter: function () {
    ...
    W.bubble = v(W.scatter, {dataLabels: {formatter: function () {
        return this.point.z
    },
        inside: !0, style: {color: "white", textShadow: "0px 0px 3px black"}, verticalAlign: "middle"}, marker: {lineColor: null, lineWidth: 1}, minSize: 8, maxSize: "20%", states: {hover: {halo: {size: 5}}}, tooltip: {pointFormat: "({point.x}, {point.y}), Size: {point.z}"}, turboThreshold: 0, zThreshold: 0});
    var Rb = da(ia, {haloPath: function () {
        return ia.prototype.haloPath.call(this, this.shapeArgs.r + this.series.options.states.hover.halo.size)
    }});
    u.bubble = da(u.scatter, {type: "bubble", pointClass: Rb, pointArrayMap: ["y", "z"], parallelArrays: ["x",
        "y", "z"], trackerGroups: ["group", "dataLabelsGroup"], bubblePadding: !0, pointAttrToOptions: {stroke: "lineColor", "stroke-width": "lineWidth", fill: "fillColor"}, applyOpacity: function (a) {
        ...
        for (a = b.length; a--;)c = b[a], d = e ? e[a] : 0, c.negative = c.z < (this.options.zThreshold || 0), d >= this.minPxSize /
            2 ? (c.shapeType = "circle", c.shapeArgs = {x: c.plotX, y: c.plotY, r: d}, c.dlBox = {x: c.plotX - d, y: c.plotY - d, width: 2 * d, height: 2 * d}) : c.shapeArgs = c.plotY = c.dlBox = r
    }, drawLegendSymbol: function (a, b) {
    ...
    if (u.bubble)W.mapbubble = v(W.bubble, {animationLimit: 500, tooltip: {pointFormat: "{point.name}: {point.z}"}}),
        u.mapbubble = da(u.bubble, {pointClass: da(ia, {applyOptions: Gb.prototype.applyOptions}), xyFromShape: !0, type: "mapbubble", pointArrayMap: ["z"], getMapData: u.map.prototype.getMapData, getBox: u.map.prototype.getBox, setData: u.map.prototype.setData});
        ...
        o(a.features, function (a) {
            ...
            b === "map" || b === "mapbubble" ?
                (i === "Polygon" ? (o(c, f), e.push("Z")) : i === "MultiPolygon" && (o(c, function (a) {
                    o(a, f)
                }), e.push("Z")), e.length && (j = {path: e})) : b === "mapline" ? (i === "LineString" ? f(c) : i === "MultiLineString" && o(c, f), e.length && (j = {path: e})) : b === "mappoint" && i === "Point" && (j = {x: c[0], y: -c[1]});
    ...
    J.mapNavigation = {buttonOptions: {alignTo: "plotBox", align: "left", verticalAlign: "top", x: 0, width: 18, height: 18, style: {fontSize: "15px", fontWeight: "bold", textAlign: "center"}, theme: {"stroke-width": 1}}, buttons: {zoomIn: {onclick: function () {
        this.mapZoom(0.5)
    ...
    K.Map = function (a, b) {
        var c = {endOnTick: !1, gridLineWidth: 0, lineWidth: 0,
            minPadding: 0, maxPadding: 0, startOnTick: !1, title: null, tickPositions: []}, d;
        d = a.series;
        a.series = null;
        a = v({chart: {panning: "xy", type: "map"}, xAxis: c, yAxis: v(c, {reversed: !0})}, a, {chart: {inverted: !1, alignTicks: !1, preserveAspectRatio: !0}});
        a.series = d;
        return new pa(a, b)
    };
    J.plotOptions.heatmap = v(J.plotOptions.scatter, {animation: !1, borderWidth: 0, nullColor: "#F8F8F8", dataLabels: {formatter: function () {
        return this.point.value
    }, verticalAlign: "middle", crop: !1, overflow: !1, style: {color: "white", fontWeight: "bold", HcTextStroke: "1px rgba(0,0,0,0.5)"}},
        marker: null, tooltip: {pointFormat: "{point.x}, {point.y}: {point.value}<br/>"}, states: {normal: {animation: !0}, hover: {brightness: 0.2}}});
    u.heatmap = da(u.scatter, v(L, {type: "heatmap", pointArrayMap: ["y", "value"], hasPointSpecificOptions: !0, supportsDrilldown: !0, getExtremesFromAll: !0, init: function () {
        ...
        drawPoints: u.column.prototype.drawPoints, animate: aa, getBox: aa, drawLegendSymbol: Ya.drawRectangle, getExtremes: function () {
            T.prototype.getExtremes.call(this, this.valueData);
            this.valueMin = this.dataMin;
            this.valueMax = this.dataMax;
            T.prototype.getExtremes.call(this)
        }}));
    L = K.TrackerMixin = {drawTrackerPoint: function () {
        ...
        j ? j.attr({d: d}) : (a.tracker = h.path(d).attr({"stroke-linejoin": "round", visibility: a.visible ? "visible" : "hidden", stroke: p, fill: c ? p : S, "stroke-width": b.lineWidth +
    ...
    q(Xa.prototype, {setItemEvents: function (a, b, c, d, e) {
        var f = this;
    ...
    q(pa.prototype, {showResetZoom: function () {
    ...
    q(ia.prototype, {select: function (a, b) {
        ...
        if (!(a === this.state && !b || this.selected && a !== "select" || f[a] && f[a].enabled === !1 || a && (j || h && i.enabled === !1) || a && l.states && l.states[a] && l.states[a].enabled === !1)) {
            if (this.graphic)g = g && this.graphic.symbolName && o.r, this.graphic.attr(v(o, g ? {x: c - g, y: d - g, width: 2 * g, height: 2 * g} : {})), k && k.hide(); else {
                if (a && i)if (g = i.radius, l = l.symbol || e.symbol,
                    k && k.currentSymbol !== l && (k = k.destroy()), k)k[b ? "animate" : "attr"]({x: c - g, y: d - g}); else if (l)e.stateMarkerGraphic = k = n.renderer.symbol(l, c - g, d - g, 2 * g, 2 * g).attr(o).add(e.markerGroup), k.currentSymbol = l;
    ...
    q(T.prototype, {onMouseOver: function () {
    ...
    q(K, {Axis: Q, Chart: pa, Color: Z, Point: ia, Tick: La, Renderer: Na, Series: T, SVGElement: H, SVGRenderer: ba, arrayMin: Qa, arrayMax: Fa, charts: V, dateFormat: $a, format: Ia, pathAnim: kb, getOptions: function () {
        return J
    }, hasBidiBug: Hb, isTouchDevice: Ab,
        numberFormat: oa, seriesTypes: u, setOptions: function (a) {
            J = v(!0, J, a);
            qb();
            return J
        }, addEvent: N, removeEvent: Y, createElement: $, discardElement: Ja, css: D, each: o, extend: q, map: Ua, merge: v, pick: p, splat: na, extendClass: da, pInt: B, wrap: X, svg: ca, canvas: ga, vml: !ca && !ga, product: "Highmaps", version: "1.0.4"})
})();
