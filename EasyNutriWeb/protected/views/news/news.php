...
if ($dataProvider->getItemCount() > 0) {
    ...
    <form id="message-list-form"
          action="<?php echo $this->createUrl($this->getId() . '/' . $this->getAction()->getId()); ?>" method="post">
        <div class="mailbox-clistview-container ui-helper-clearfix">
            ...
            <?php if ($this->module->isAdmin()) : ?>
                <div style="clear:left"><span class="mailbox-buttons-label">With selected:</span>
                    <input type="submit" id="mailbox-action-delete" class="btn mailbox-button" name="button[delete]"
                           value="delete"/>
