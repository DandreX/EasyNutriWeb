...
//        ));
     ...
     * @return Notificacoes the loaded model
     * @throws CHttpException
     */
    public function loadModel($id)
    {
        $model = Notificacoes::model()->findByPk($id);
        if ($model === null)
     ...
     * @param Notificacoes $model the model to be validated
     */
    protected function performAjaxValidation($model)
    {
        if (isset($_POST['ajax']) && $_POST['ajax'] === 'notificacoes-form') {
